...
class ProductTileCart extends StatelessWidget {
  ...
  ProductTileCart(
      {super.key, required this.product, required this.cartblocBloc});
            ...
            children: [
              ...
              Row(
                children: [
                  IconButton(
                      onPressed: () {
                        // cartblocBloc.remove(HomeProductWishListButtonClickedEvent(
                        //     clicked: product));
                      },
                  ...
                  IconButton(
                      onPressed: () {
                        cartblocBloc.add(
                            CartRemoveItemEvent(productListDataModel: product));
                      },
